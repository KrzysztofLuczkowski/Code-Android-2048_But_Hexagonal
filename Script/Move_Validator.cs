...
public class MoveValidator : MonoBehaviour
{
    ...
    {
        if (gameOverPanel.activeInHierarchy || menuPanel.activeInHierarchy || collectionPanel.activeInHierarchy || popupPanel.activeInHierarchy)
        {
            return false;
        }
    ...
    {
        if (menuPanel.activeInHierarchy || collectionPanel.activeInHierarchy || popupPanel.activeInHierarchy)
        {
            return true;
        }
