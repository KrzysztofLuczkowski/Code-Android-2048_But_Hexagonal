...
namespace GoogleMobileAds.Samples
{
    ...
    public class GoogleMobileAdsConsentController : MonoBehaviour
    {
        ...
        public void GatherConsent(Action<string> onComplete)
        {
            ...
            ConsentInformation.Update(requestParameters, (FormError updateError) =>
            {
                ...
                ConsentForm.LoadAndShowConsentFormIfRequired((FormError showError) =>
                {
                    ...
                    {
                        // Restart the application by reloading the current scene
        ...
        void UpdatePrivacyButton()
        {
            ...
            {
                // Ukrywamy przycisk w hierarchii, jeœli zgoda nie jest wymagana ani uzyskana.
                _privacyButton.gameObject.SetActive(
